<template>
    <div class="row py-5 mx-4">
        ...
        <div class="col-12 col-md-7 py-md-3">
            <p>Ön szerint mennyi tanulás szükséges ahhoz, hogy valaki teljes hatékonysággal tudja az Ön munkáját
                ellátni?</p>
        </div>
        <div class="col-12 col-md-5 py-md-3 mb-3">
            <select class="custom-select">
        ...
        <div class="col-12 col-md-5 py-md-3 mb-3">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio17"
                       value="option1">
                <label class="form-check-label" for="inlineRadio17">Igen</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio18"
                       value="option2">
        ...
        <div class="col-12 col-md-5 py-md-3 mb-3">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio19"
                       value="option1">
